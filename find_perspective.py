...
#reading in an image
filename = 'trouble_again.jpg'
#filename = 'thresholded.jpg'
...
def redrawFiles():
    ...
    print("p4y = " + str(p4y))
    print("--------------------------")
    print("src_points = np.float32([(" + str(p1x) + ", " + str(p1y) + "), (" + str(p2x) + ", " + str(p2y) + "), (" + str(p3x) + ", " + str(p3y) + "), (" + str(p4x) + ", " + str(p4y) + ")])")
    print("dst_points = np.float32([(" + str(p1x) + ", 1.0), (" + str(p1x) + ", 0.0), (" + str(p4x) + ", 0.0), (" + str(p4x) + ", 1.0)])")
